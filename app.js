...
var myUserId = "@n.amjadian:alphaco.cloud";
var myBaseUrl = "https://matrix.alphaco.cloud";
var myAccessToken = "syt_bi5hbWphZGlhbg_djNpImaYsmyVEjIKlNhG_4G8jxw";
...
// const client = sdk.createClient(myBaseUrl);

// matrixClient.login("m.login.password", {"user": myUserId, "password": "965313(^%#!#"}).then((response) => {
